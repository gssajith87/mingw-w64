...
int main() 
{
  ...
  DEFINE_TEST_FUNCTION(catan, FUNC_BEHAVIOR_CONJ | FUNC_BEHAVIOR_ODD);

  TEST_PROLOGUE

  DECLARE_TEST (__FLT_CST(0.0), __FLT_CST(0.0), __FLT_CST(0.0), __FLT_CST(0.0), 0, 0)
  DECLARE_TEST (__FLT_CST(0.0), __FLT_CST(1.0), __FLT_CST(0.0), INFINITY,  0, 0)
  DECLARE_TEST (__FLT_CST(0.0), INFINITY , __FLT_PI_2, __FLT_CST(0.0),  0, 0)
  DECLARE_TEST (__FLT_CST(0.0), __FLT_NAN, __FLT_NAN, __FLT_NAN, 0, 0)

  DECLARE_TEST (__FLT_CST(42.42), INFINITY , __FLT_PI_2, __FLT_CST(0.0),  0, 0)
  DECLARE_TEST (__FLT_CST(42.42), __FLT_NAN, __FLT_NAN, __FLT_NAN, 0, 0)

  DECLARE_TEST (INFINITY, __FLT_CST(42.42),  __FLT_PI_2, __FLT_CST(0.0), 0, 0)
  DECLARE_TEST (INFINITY, INFINITY, __FLT_PI_2, __FLT_CST(0.0), 0, 0)
  DECLARE_TEST (INFINITY, __FLT_NAN, __FLT_PI_2, __FLT_CST(0.0), 0, 1)
  ...
  DECLARE_TEST (__FLT_NAN, INFINITY , __FLT_NAN, __FLT_CST(0.0), 0, 0)
