...
int main()
{
  ...
  DEFINE_TEST_FUNCTION(casin, FUNC_BEHAVIOR_CONJ | FUNC_BEHAVIOR_ODD);
  ...
  DECLARE_TEST ( __FLT_CST(42.42), INFINITY, __FLT_CST(0.0), INFINITY, 	0, 0)

  DECLARE_TEST (INFINITY, __FLT_CST(42.42), __FLT_PI_2,	INFINITY, 0, 0)
