...
int main()
{
  /* Annex G.6 csin(z) = -i csinh (iz)
     ...
     Swap the input, swap the output and you have the test. (sign-dontcare swapped)
  ...
  DEFINE_TEST_FUNCTION(csin, FUNC_BEHAVIOR_CONJ | FUNC_BEHAVIOR_ODD);

  TEST_PROLOGUE

  DECLARE_TEST (__FLT_CST(0.0), __FLT_CST(0.0), __FLT_CST(0.0), __FLT_CST(0.0), 0, 0)
  DECLARE_TEST (__FLT_CST(0.0),  INFINITY,  __FLT_CST(0.0), INFINITY, 0, 0)
  DECLARE_TEST (__FLT_CST(0.0), __FLT_NAN, __FLT_CST(0.0), __FLT_NAN, 0, 0)

  DECLARE_TEST (__FLT_CST(42.42), INFINITY, INFINITY*__FLT_ABI(sin)(__FLT_CST(42.42)), INFINITY*__FLT_ABI(cos)(__FLT_CST(42.42)), 0, 0)
  DECLARE_TEST (__FLT_CST(42.42), __FLT_NAN, __FLT_NAN, __FLT_NAN,	0, 0)

  DECLARE_TEST (-INFINITY, __FLT_CST( 0.0), __FLT_NAN, __FLT_CST(0.0), 0, 1)
  DECLARE_TEST (-INFINITY, __FLT_CST(42.42), __FLT_NAN, __FLT_NAN,	0, 0)
  DECLARE_TEST (-INFINITY, INFINITY,  __FLT_NAN, INFINITY, 0, 1)
  DECLARE_TEST (-INFINITY, __FLT_NAN, __FLT_NAN, __FLT_NAN,	0, 0)
  ...
  DECLARE_TEST (__FLT_NAN, INFINITY, __FLT_NAN,	INFINITY, 0, 1)
