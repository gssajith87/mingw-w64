...
int main()
{
  /* Annex G.6 ccos(z) = ccosh(iz)
     Swap the input, and negate the real.
  ...
  DEFINE_TEST_FUNCTION(ccos, FUNC_BEHAVIOR_CONJ | FUNC_BEHAVIOR_EVEN);

  TEST_PROLOGUE

  DECLARE_TEST (__FLT_CST(-0.0), __FLT_CST(0.0), __FLT_CST(1.0), __FLT_CST(0.0), 0, 0)
  DECLARE_TEST (__FLT_CST(-0.0), INFINITY, INFINITY, __FLT_CST(0.0),	0, 0)
  ...
  DECLARE_TEST (__FLT_CST(-42.42), INFINITY, INFINITY*__FLT_ABI(cos)(__FLT_CST(42.42)), INFINITY*__FLT_ABI(sin)(__FLT_CST(42.42)),	0, 0)
