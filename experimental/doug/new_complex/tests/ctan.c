...
int main() 
{
  /* Annex G.6 ctan(z) = -i ctanh(iz)
     Swap the input, swap the output, with unspecified swap.
  ...
  DEFINE_TEST_FUNCTION(ctan, FUNC_BEHAVIOR_CONJ | FUNC_BEHAVIOR_ODD);

  TEST_PROLOGUE

  DECLARE_TEST (__FLT_CST(0.0), __FLT_CST(0.0),  __FLT_CST(0.0), __FLT_CST(0.0), 0, 0)
  DECLARE_TEST (__FLT_CST(0.0), INFINITY , __FLT_CST(0.0) * __FLT_ABI(sin) (__FLT_CST(2.0)*__FLT_CST(0.0)), __FLT_CST(1.0), 0, 0)
  ...
  DECLARE_TEST (__FLT_CST(42.42), INFINITY, __FLT_CST(0.0) * __FLT_ABI(sin) (__FLT_CST(2.0)*__FLT_CST(42.42)), __FLT_CST(1.0), 0, 0)

  DECLARE_TEST (INFINITY, __FLT_CST(42.42),  __FLT_NAN, __FLT_NAN, 0, 0)
  DECLARE_TEST (INFINITY, INFINITY, __FLT_CST(0.0), __FLT_CST(1.0), 1, 0)
  DECLARE_TEST (INFINITY, __FLT_NAN, __FLT_NAN, __FLT_NAN, 0, 0)

  DECLARE_TEST (__FLT_NAN, __FLT_CST(42.42), __FLT_NAN, __FLT_NAN, 0, 0)
  DECLARE_TEST (__FLT_NAN, INFINITY, __FLT_CST(0.0), __FLT_CST(1.0), 1, 0)
