  ...
  def __init__(self, **kwargs):
    ...
    self.addStep(ShellCommandConditional,
                 ...
                 command=["scripts/upload.py",
                          WithProperties("%(sf_group_id:+--group-id)s"),
                          WithProperties("%(sf_group_id:-)s"),
                          WithProperties("%(sf_package_id:+--package-id)s"),
                          WithProperties("%(sf_package_id:-)s"),
                          WithProperties("%(sf_release_id:+--release-id)s"),
                          WithProperties("%(sf_release_id:-)s"),
