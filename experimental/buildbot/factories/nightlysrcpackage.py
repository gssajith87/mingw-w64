...
#                     extra_args=["--trust-server-cert"]))
    ...
    self.addStep(TriggerBuilders
                  (name="start-build",
                   ...
                   set_properties={"is_nightly":           WithProperties("is_nightly"),
                                   "datestamp":            WithProperties("datestamp"),
                                   "binutils_branch":      WithProperties("binutils_branch"),
                                   "gcc_branch":           WithProperties("gcc_branch"),
                                   "mingw_branch":         WithProperties("mingw_branch"),
                                   "binutils_config_args": WithProperties("binutils_config_args"),
                                   "gcc_config_args":      WithProperties("gcc_config_args"),
                                   "mingw_config_args":    WithProperties("mingw_config_args"),
                                   "gcc_revision":         WithProperties("gcc_revision"),
                                   "mingw_revision":       WithProperties("mingw_revision"),
                                   "destname_format":      WithProperties("destname_format"),
                                   "masterdir":            WithProperties("masterdir"),
                                   "path":                 WithProperties("path"),
