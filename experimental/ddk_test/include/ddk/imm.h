...
WINBOOL WINAPI ImmUnlockIMC(HIMC);
...
WINBOOL WINAPI ImmUnlockIMCC(HIMCC);
...
WINBOOL WINAPI ImmGenerateMessage(HIMC);
...
WINBOOL WINAPI ImmTranslateMessage(HWND, UINT, WPARAM, LPARAM);
HWND WINAPI ImmCreateSoftKeyboard(UINT, UINT, int, int);
WINBOOL WINAPI ImmDestroySoftKeyboard(HWND);
WINBOOL WINAPI ImmShowSoftKeyboard(HWND, int);

WINBOOL WINAPI ImeInquire(LPIMEINFO, LPWSTR, LPCWSTR lpszOptions);
WINBOOL WINAPI ImeConfigure (HKL, HWND, DWORD, LPVOID);
DWORD WINAPI ImeConversionList(HIMC, LPCWSTR, LPCANDIDATELIST,DWORD,UINT);
WINBOOL WINAPI ImeDestroy(UINT);
LRESULT WINAPI ImeEscape(HIMC, UINT, LPVOID);
WINBOOL WINAPI ImeProcessKey(HIMC, UINT, LPARAM, CONST LPBYTE);
WINBOOL WINAPI ImeSelect(HIMC, WINBOOL);
WINBOOL WINAPI ImeSetActiveContext(HIMC, WINBOOL);
UINT WINAPI ImeToAsciiEx(UINT, UINT, CONST LPBYTE, LPDWORD, UINT, HIMC);
WINBOOL WINAPI NotifyIME(HIMC, DWORD, DWORD, DWORD);
WINBOOL WINAPI ImeRegisterWord(LPCWSTR, DWORD, LPCWSTR);
WINBOOL WINAPI ImeUnregisterWord(LPCWSTR, DWORD, LPCWSTR);
...
WINBOOL WINAPI ImeSetCompositionString(HIMC, DWORD, LPCVOID, DWORD, LPCVOID, DWORD);
