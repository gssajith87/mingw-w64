...
SHSTDAPI_(WINBOOL) SHChangeNotifyRegister( HWND hwnd, SHCHANGENOTIFYENTRY *pshcne);
SHSTDAPI_(WINBOOL) SHChangeNotifyDeregister( HWND hwnd );
SHSTDAPI_(void)    SHChangeNotifyFree( FILECHANGENOTIFY *pfcn );
