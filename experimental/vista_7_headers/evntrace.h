...
#define EVENT_TRACE_TYPE_REGKCBDMP		0x16	/* FIXME: MS doesnt define this anymore */
...
#define EVENT_TRACE_FLAG_VOLMGR			0x00200000	/* FIXME: MS doesnt define this anymore */
